            ...
            <div className="relative group ml-0 md:ml-9 verified-phone-display">
              <div className="relative">
                ...
                <div className="absolute right-5 top-1/2 -translate-y-1/2 flex items-center gap-2 pointer-events-none">
                  <span className="hidden sm:inline-block text-[10px] font-black text-brand-primary uppercase tracking-widest bg-white px-2 py-1 rounded-md border border-brand-primary/20 shadow-sm">{t('sections.verified')}</span>
                  <svg className="w-5 h-5 text-brand-primary" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                </div>
              </div>
              <p className="text-[10px] text-brand-text-secondary/50 mt-1.5 ml-4 font-medium italic">{t('sections.verified_hint')}</p>
            </div>
